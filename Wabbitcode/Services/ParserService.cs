...
namespace Revsoft.Wabbitcode.Services
{
	public class ParserService : IParserService
	{
		...
		{
			IProject project = objects[0] as IProject;
			if (project == null)
				throw new Exception("First param is not of type IProject");
			Project = project;
		}
		...
		internal void RemoveParseData(string fullPath)
		{
			ParserInformation replaceMe = Project.GetParseInfo(fullPath);
			if (replaceMe != null)
				Project.ParseInfo.Remove(replaceMe);
		}
