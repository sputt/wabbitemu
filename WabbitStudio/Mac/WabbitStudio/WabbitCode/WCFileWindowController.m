...
- (NSArray *)toolbarDefaultItemIdentifiers:(NSToolbar *)toolbar {
	return [NSArray arrayWithObjects:NSToolbarFlexibleSpaceItemIdentifier,kWCProjectToolbarStatusViewItemIdentifier,NSToolbarFlexibleSpaceItemIdentifier,kWCProjectToolbarProjectWindowItemIdentifier,nil];
}
