...
+ (void)initialize {
	...
	[preferences setObject:[NSKeyedArchiver archivedDataWithRootObject:[NSColor colorWithCalibratedRed:0.75 green:0.0 blue:0.0 alpha:1.0]] forKey:kWCPreferencesEditorErrorLineHighlightColorKey];
