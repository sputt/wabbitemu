...
- (void)windowWillLoad {
	...
	[_templates addObject:[WCProjectTemplate objectWithName:NSLocalizedString(@"Built-in Templates", @"built-in templates header title") icon:[NSImage imageNamed:@"NSApplicationIcon"]]];
